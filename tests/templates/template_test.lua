...
describe(
  "Template", function()
    ...
    it(
      "renders an empty template", function()
    ...
    it(
      "renders a literal string", function()
    ...
    it(
      "renders a literal multi-line string", function()
...
hello
  world]], {}
    ...
    it(
      "renders a basic expression variable #xfail", function()
    ...
    it(
      "renders a literal string with literal expressions", function()
    ...
    it(
      "renders a nil expression", function()
    ...
    it(
      "renders a false expression", function()
    ...
    it(
      "renders a true expression", function()
    ...
    it(
      "renders an integer expression", function()
    ...
    it(
      "renders a float expression", function()
    ...
    it(
      "renders a float without a fraction expression", function()
    ...
    it(
      "renders dotted access expression variable", function()
        -- TODO - {{ foo.bar }}
      end
    )

    it(
      "renders subscript expression variable", function()
        -- TODO - {{ foo['bar'] }}
      end
    )

    it(
      "renders a function expression", function()
        -- TODO - {{ foo('42') }}
      end
    )

    it(
      "renders a expression variable method", function()
        -- TODO - {{ foo.bar(baz) }}
      end
    )

    it(
      "renders with undefined variables", function()
        -- TODO: render as an empty string.
      end
    )

    it(
      "errors when undefined is used in an expression", function()
        -- TODO: when undefined is used with something like addition, return an error.
      end
    )

    it(
      "renders with different data", function()
