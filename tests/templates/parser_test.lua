...
describe(
  "Parser", function()
    ...
    it(
      "parses raw text to an AST", function()
        local parser = Parser()
    ...
    it(
      "parses an expression to an AST #xfail", function()
        local parser = Parser()
    ...
    it(
      "parses an expression single quoted literal to an AST", function()
        local parser = Parser()
    ...
    it(
      "parses an expression double quoted literal to an AST", function()
        local parser = Parser()
        local source = "before {{ \"hello\" }} after"
    ...
    it(
      "parses an expression literal with newline to an AST", function()
        local parser = Parser()
...
world" }} after]]
    ...
    it(
      "parses a nil expression", function()
        local parser = Parser()
    ...
    it(
      "parses a false expression", function()
        local parser = Parser()
    ...
    it(
      "parses a true expression", function()
        local parser = Parser()
    ...
    it(
      "parses an integer expression", function()
        local parser = Parser()
    ...
    it(
      "parses a float expression", function()
        local parser = Parser()
